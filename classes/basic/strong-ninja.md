...
Acrobatics (Str), Climb (Str), Craft (structural) (Int), Genjutsu (Cha), Handle Animal (Cha), Knowledge (arcana, local) (Int), Linguistics (—), Profession (Wis), Swim (Str), Taijutsu (Str).
