...
Chakra Control (Wis), Craft (calligraphy, chemical, electronic, mechanical, pharmaceutical, structural, visual art, writing) (Int), Disable Device (Int), Knowledge (arcana, engineering, history, local, nature, nobility, religion) (Int), Linguistics (—), Ninjutsu (Int), Perception (Int), Profession (Wis), Sense Motive (Wis), Survival (Wis).
