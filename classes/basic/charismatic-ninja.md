...
Bluff (Cha), Chakra Control (Wis), Craft (calligraphy, visual art, writing) (Int), Diplomacy (Cha), Disguise (Cha), Genjutsu (Cha), Handle Animal (Cha), Intimidate (Cha), Knowledge (arcana, history, local, nobility, religion) (Int), Linguistics (—), Perform (act, dance, keyboards, percussion instruments, sing, stand-up, stringed instruments, wind instruments) (Cha), Profession (Wis), Sense Motive (Wis).
